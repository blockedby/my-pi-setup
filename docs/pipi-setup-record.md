...
- **Pending:** Push this operation-record follow-up, confirm PR #14 is open against `main`, then drop the verified transfer stash. Merge remains a separate user decision.
