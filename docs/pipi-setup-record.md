...
- **Pending:** Open the parent PR to `main` and reload or restart the active Pipi session. Parent merge remains a separate decision; after merge, rerun the primary installer and remove the temporary filtered worktree package before cleanup.
