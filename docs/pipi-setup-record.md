...
- **Pending:** Open the PR to `main`, install a filtered local package entry for the skill without duplicating existing Pipi resources, verify discovery, and reload the active Pipi session if needed. Merge remains a separate decision.
