...
- **Pending:** Commit and open the separate implementation PR, refresh it against current `main`, and rerun verification if the target refresh changes content. Merge, installation, reload, and rollout remain pending explicit user approval.
