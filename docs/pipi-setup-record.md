...
- **Pending:** Run the complete deterministic test/review flow, publish and merge the follow-up fix, rerun the real installer, and confirm exact dependency metadata with no pending install scripts.
