...
- **Pending:** Amend the refreshed record, rerun target preparation, push the follow-up branch, open its pull request, then merge/install/reload so the main agent receives the revised tool guidance.
