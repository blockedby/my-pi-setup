...
- **Pending:** Version bump committed as `65a0281`; optimize rollout to reuse verified dependencies with regression coverage. Prepare/publish/merge the upgrade PR, synchronize primary `main`, reinstall from the primary package, and reload/restart Pipi.
...
- **Pending:** Commit the optimization separately, prepare/publish/merge the upgrade PR, synchronize primary `main`, reinstall from the primary package without repeating verified repository dependencies, and reload/restart Pipi.
