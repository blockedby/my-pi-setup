...
- **Pending:** Merge PR #25, synchronize primary `main`, reinstall from the primary package without repeating verified repository dependencies, and reload/restart Pipi.
