...
- **Pending:** Review and merge the implementation through the normal PR-first flow, then install/reload Pipi only when explicitly requested. A disposable live model/backend audit-pipeline smoke remains intentionally unrun.
