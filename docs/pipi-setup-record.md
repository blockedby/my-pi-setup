...
- **Pending:** Commit and push the isolated branch, open the pull request against `blockedby/my-pi-setup` `main`, run target-branch preparation, and record final evidence.
