...
- **Pending:** Commit, open the PR, prepare against current `main` (which advanced with branding PRs #27/#28), rerun required checks after any content-changing rebase, and push the accepted branch. Do not merge or install unless separately requested.
