...
- **Pending:** Publish and merge the corrective PR under the user's existing rollout authorization, reinstall from merged primary, and repeat the fresh Herdr pane acceptance before claiming completion.
