...
- **Pending:** Commit the isolated version bump, then optimize rollout to reuse verified dependencies with regression coverage. Prepare/publish/merge the upgrade PR, synchronize primary `main`, reinstall from the primary package, and reload/restart Pipi.
