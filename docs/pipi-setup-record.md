...
- **Pending:** Commit and push the parent gitlink and record, open and prepare the parent PR, merge it as authorized, synchronize `main`, reinstall the canonical skill, verify source/installed parity, and clean up the feature worktree and branch.
