...
export const FEATURE_CANDIDATE_STEERING_LIMIT_MS = 10 * 60 * 1_000;
export const FEATURE_CANDIDATE_STEERING_WARNING_MS =
  FEATURE_CANDIDATE_STEERING_LIMIT_MS * 0.8;
