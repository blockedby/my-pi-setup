...
export const FEATURE_CANDIDATE_WAVE_LIMIT_MS = 10 * 60 * 1_000;
export const FEATURE_CANDIDATE_WAVE_WARNING_MS =
  FEATURE_CANDIDATE_WAVE_LIMIT_MS * 0.8;
